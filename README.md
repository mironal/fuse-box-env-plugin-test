...
Bundle "app"
    ...
    src/index.js
└──  (1 files,  246 Bytes) default
size: 246 Bytes in 37ms
✨  Done in 0.71s.
yarn run v1.3.2
$ node dist/app.js
undefined undefined
...
var __process_env__ = {"NODE_ENV":"development","bar":"barbar"};
FuseBox.pkg("default", {}, function(___scope___){
___scope___.file("src/index.js", function(exports, require, module, __filename, __dirname){

console.log(process.env.NODE_ENV, process.env.bar);
